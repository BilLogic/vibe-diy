...
/**
 * Variation B: Clean & Airy
 *
 * Light background, generous whitespace, welcoming editorial feel.
 * Best for: Broad audience appeal, content-first experiences.
 */
export function VariationB() {
    ...
    return (
        <Flex direction="column" alignSecondary="stretch">
            {/* Hero Section */}
            <Section paddingBottom="1600" paddingTop="1600">
                <Flex container direction="column" gap="800" alignSecondary="center">
                    <Flex gap="200" alignPrimary="center" wrap>
                        <Tag>Live Course</Tag>
                    ...
                    />
                    <Flex direction={isMobile ? "column" : "row"} gap="400" alignPrimary="center" alignSecondary="center">
                    ...
                    <Flex gap="800" alignPrimary="center" wrap>
                        <Flex direction="column" gap="100" alignSecondary="center">
            ...
            {/* Enrollment card — full-width banner */}
            <Section padding="800" variant="stroke">
                <Flex container direction={isMobile ? "column" : "row"} gap="800" alignSecondary={isMobile ? "stretch" : "center"} alignPrimary="space-between">
                    <Flex direction="column" gap="200">
                        <TextHeading>Next cohort: March 10, 2025</TextHeading>
                        <Text>8 weeks · Live sessions every Tuesday · Lifetime access to recordings</Text>
                    </Flex>
                    <Flex direction={isMobile ? "column" : "row"} gap="400" alignSecondary={isMobile ? "stretch" : "center"} wrap>
                        <Button variant="primary" onPress={() => { }}>Reserve Your Spot</Button>
                        <Button variant="neutral" onPress={() => { }}>Download Syllabus</Button>
                    </Flex>
                </Flex>
            </Section>

            {/* Learning Outcomes — 3-column cards */}
            <Section padding={sectionPadding} variant="neutral">
                <Flex container direction="column" gap={flexGap}>
                    ...
                    <Flex type="third" gap="600" wrap>
                        {[
                            { icon: "✦", title: "Prompt Engineering", desc: "Write effective prompts for design tools, image generators, and AI assistants." },
                            { icon: "✦", title: "AI Research Methods", desc: "Synthesize user research, generate personas, and map insights with AI." },
                            { icon: "✦", title: "AI Prototyping", desc: "Build interactive prototypes faster using generative AI tools." },
                            { icon: "✦", title: "UX Evaluation", desc: "Assess AI-generated designs for quality, bias, and usability." },
                            { icon: "✦", title: "Responsible AI", desc: "Design ethical, transparent, and inclusive AI-powered experiences." },
                            { icon: "✦", title: "Shipping with Eng", desc: "Collaborate effectively with engineering teams to ship AI features." },
                        ].map((item) => (
                            <Section key={item.title} variant="stroke" padding="800">
            ...
            <Section padding={sectionPadding}>
                <Flex container direction="column" gap="800" alignSecondary="center">
                    ...
                    <TextSmall>30-day money-back guarantee · No coding required</TextSmall>
                </Flex>
            </Section>
        </Flex>
    );
